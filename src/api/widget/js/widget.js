(function() {
    ...
    const widgetHTML = `
        ...
        <button class="rag-chat-toggle" id="ragChatToggle"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#ffffffff" viewBox="0 0 256 256"><path d="M172,112a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h68A8,8,0,0,1,172,112Zm-8,24H96a8,8,0,0,0,0,16h68a8,8,0,0,0,0-16Zm68-12A100.11,100.11,0,0,1,132,224H48a16,16,0,0,1-16-16V124a100,100,0,0,1,200,0Zm-16,0a84,84,0,0,0-168,0v84h84A84.09,84.09,0,0,0,216,124Z"></path></svg></button>
    `;
